...
a. Using the monthly release from August 2018, data was filtered to sites with a status of either 'designated', 'inscribed', or 'established' following IUCN definition of a protected area (http://www.biodiversitya-z.org/content/protected-area). UNESCO Man and Biosphere Reserves are excluded by this definition.         
...
c. Protected areas were then intersected with global boundaries for Exclusive Economic Zones (EEZ) and terrestrial borders to delineate as marine (within EEZ) or terrestrial.  Geomteries were repaired as necessary. Areas beyond national jurisdiction (ABNJ) were not included. The basemap layer used was provided by Brooks et al.2016 (https://doi.org/10.5061/dryad.6gb90.2).   
...
e. The global extent of protected area was calculated in M ha as the total coverage in each subregion for terrestrial and marine sites. These data were also used to calculate  protected area coverage separately for terrestrial and marine. Mollweide projection was used for area calculations. 
