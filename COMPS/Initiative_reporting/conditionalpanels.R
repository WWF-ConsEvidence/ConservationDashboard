                  ...
                  tags$table(style = "width: 35%",
                             tags$tr(tags$td(style = "width: 35%",
                                             ...
                                             actionButton(inputId = "addout1subcat1Data",
                                                          label = "Add Row")),
                                     tags$td(style = "width: 65%",
                                             align = "left",
                                             h6(tags$em("If you click 'Add Row' by mistake, leave the Year/Value as 9999 and it will automatically delete."))))),
