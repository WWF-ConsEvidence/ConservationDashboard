...
output$initiativestatecharcount <- reactive({ paste0(325-nchar(input$initiativestatement), ' characters remaining.' )})
output$initiativejustcharcount <- reactive({ paste0(350-nchar(input$initiativejust), ' characters remaining.' )})
