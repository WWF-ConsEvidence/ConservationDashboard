...
formData3 <- reactive({
  newdf <- milestonedata()
  newdf <- newdf %>% filter(Milestone!="[CLICK HERE TO INSERT NEW MILESTONE TEXT]" & Milestone!="")
...
formData4 <- reactive({
  ...
  out1subcat1df <- out1subcat1df %>% filter(Year!=9999)
  out1subcat2df <- out1subcat2df %>% filter(Year!=9999)
  out1subcat3df <- out1subcat3df %>% filter(Year!=9999)
  ...
  out2subcat1df <- out2subcat1df %>% filter(Year!=9999)
  out2subcat2df <- out2subcat2df %>% filter(Year!=9999)
  out2subcat3df <- out2subcat3df %>% filter(Year!=9999)
  ...
  path1subcat1df <- path1subcat1df %>% filter(Year!=9999)
  path1subcat2df <- path1subcat2df %>% filter(Year!=9999)
  path1subcat3df <- path1subcat3df %>% filter(Year!=9999)
  ...
  path2subcat1df <- path2subcat1df %>% filter(Year!=9999)
  path2subcat2df <- path2subcat2df %>% filter(Year!=9999)
  path2subcat3df <- path2subcat3df %>% filter(Year!=9999)
