...
server <- function(input, output, session) {
  ...
  init_indicator_dim <<- import('responses/FY21_init_indicator_dim.csv', integer64 = "numeric")
  init_indicator_fact <<- import('responses/FY21_init_indicator_fact.csv', integer64 = "numeric")
  milestones <<- import('responses/FY21_milestones.csv', integer64 = "numeric") %>% 
  ...
  saveData <- function(data1,data2,data3,data4) {
    ...
    data1.combined <- rbind(initiative_dim,
